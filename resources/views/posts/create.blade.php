                    ...
                    <div class="card-body p-2 p-md-5 mt-0">
                        ...
                        <form class="px-md-2" action="{{ route('posts.store') }}" method="POST">
                            ...
                            <div class="form-outline mb-1">
                                ...
                                <textarea type="text" id="plainDescription" class="textarea form-control form-control-lg"
                                    value="" name="plain_description"
                                    placeholder="Plain description" >{{ old('plain_description') }}</textarea>
                            </div>
                            ...
                            <div class="form-outline mb-1">
                                ...
                                <textarea type="text" id="htmlDescription" class="textarea form-control form-control-lg"
                                    value="" name="html_description"
                                    placeholder="HTML Description" >{{ old('html_description') }}</textarea>
                            </div>
                            ...
                            <div class="form-outline mb-1 ui-widget">
                                ...
                                <input id="tags" class="form-control form-control-lg" name="tag" value="{{ old('tag') }}" placeholder="Tag">
